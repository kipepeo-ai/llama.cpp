...
GGML_API void quantize_row_africa_1_28_ref(const float * GGML_RESTRICT x, block_africa_1_28 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_africa_1_58_ref(const float * GGML_RESTRICT x, block_africa_1_58 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_africa_1_28(const block_africa_1_28 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_africa_1_58(const block_africa_1_58 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
